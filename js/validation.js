function validate()
{
    ...
    if(flag==0){
        ...
        if(id == "" || id == "null")
        {
            document.getElementById('id_error').innerHTML="Registration Id is required"
            flag = 1;
            //return false;
        }
        else if(id.length < 8 || id.length > 9)
        {
            document.getElementById('id_error').innerHTML="Registration Id must be 9 digit long"
            flag = 1;
            //return false;
        }
        else{
        ...
        if(sem == "" || sem == "null")
        {
            document.getElementById('sem_error').innerHTML="Semester is required"
            flag = 1;
            //return false;
        }
        else if(sem.length > 2 || isNaN(sem))
        {
            document.getElementById('sem_error').innerHTML="Please enter a valid semester!!!"
            flag = 1;
            //return false;
        }
        else{
