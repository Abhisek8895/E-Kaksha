...
<div class="page">
	<div class="registration_form">
		...
		<form action="reg_db.php" method="post" onsubmit="return validate();">
			<div class="registration_box">
				...
				<div class="box_input">
					...
					<input type="text" id="semester"  name = "sem" >
					<label id="sem_error" class="form-label text-danger"></label>
				</div>
				...
				<div class="box_input">
                    ...
                    <a href="login_page.php">Click Here</a>
                </div>
			</div>
		</form>
